<!-- Data Table area End-->
<div class="modal fade" id="eliminar_departamento" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h2>¿Esta seguro que desea eliminar este departamento?</h2>
...
<div class="modal fade" id="claverrot" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            {!! Form::open(['route' => ['departamentos.destroy',1033], 'method' => 'DELETE']) !!}
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            ...
                            <input type="text" name="id_departamento_eliminar" id="id_departamento_eliminar">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
