...
<head>
    ...
    <title>Bienen | Inicio de sesión</title>
...
footer{
    background-color: rgb(27,88,171);
    height: 10vh;
    color:#fff;
    padding: 0;
    text-align: center;
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt>
                    <img src="{{ asset('assets/img/licancabur.png') }}" alt="IMG">
                </div>
                <div class="logo-mobile">
                    <img src="{{ asset('assets/img/licancabur.png') }}" alt="IMG" class="logo-mobile">
                </div>
